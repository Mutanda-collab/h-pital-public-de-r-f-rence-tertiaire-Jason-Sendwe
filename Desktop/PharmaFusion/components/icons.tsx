...
export const PharmaFusionLogo: React.FC<IconProps> = ({ className }) => (
...
export const PillIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-2.818-2.223L5.61 14.12a2.25 2.25 0 0 1-1.09-1.928V9.17a2.25 2.25 0 0 1 1.09-1.928l1.102-.592a3 3 0 0 0 2.818-2.223M14.47 16.122a3 3 0 0 1 2.818-2.223l1.102-.592a2.25 2.25 0 0 0 1.09-1.928V9.17a2.25 2.25 0 0 0-1.09-1.928l-1.102-.592a3 3 0 0 1-2.818-2.223" />
  </svg>
);
...
export const CalculatorIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm3-6h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm3-6h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008ZM12 6.75h.008v.008H12V6.75ZM3.75 3v18h16.5V3H3.75Z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 0 1 .816-.331c1.178 0 2.345-.118 3.462-.354 1.584-.333 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
    </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c-1.472 0-2.882.265-4.185.75m-5.13 0a48.417 48.417 0 0 1-4.185-.75m13.5 13.5c-1.472 0-2.882.265-4.185.75M5.25 18.72A48.416 48.416 0 0 1 12 18c2.291 0 4.545.16 6.75.47m-13.5 0c1.472 0 2.882.265 4.185.75m5.13 0a48.417 48.417 0 0 0 4.185-.75" />
    </svg>
);
...
export const UserOnScaleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 15.75a7.5 7.5 0 0 0-15 0" />
...
export const SirenIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.828 14.828a4.083 4.083 0 0 1-5.656 0 4.083 4.083 0 0 1 0-5.656 4.083 4.083 0 0 1 5.656 0 4.083 4.083 0 0 1 0 5.656Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L12 12" />
...
export const PrintIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6 18.229m0 0c.561.536 1.182 1.07 1.845 1.575a21.035 21.035 0 0 0 5.415 2.13m-7.26-3.705a21.035 21.035 0 0 1 5.415-2.13m-5.415 2.13H3m3.72-3.705L3.72 18.23m13.56-4.401c.24-.03.48-.062.72-.096m-.72.096a42.415 42.415 0 0 0-10.56 0m10.56 0L18 18.229m0 0c-.561.536-1.182 1.07-1.845 1.575a21.035 21.035 0 0 1-5.415 2.13m7.26-3.705a21.035 21.035 0 0 0-5.415-2.13m5.415 2.13H21m-3.72-3.705L20.28 18.23m-7.5-14.22h.008v.008h-.008v-.008Z" />
    </svg>
);
